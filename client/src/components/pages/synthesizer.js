...
export const Synthesizer = () => {
  function handleKey(e){
    ...
    if(e.currentTarget.className === "black-key"){
      ...
      console.log("Clicked " + e.currentTarget.textContent[e.currentTarget.textContent.length -1]);
        ...
        <div class="screen">
          ...
          <div class="keyboard">
            <ul id="piano" class="piano">
              <li data-note="C3" class="key" onClick={(e) => handleKey(e)}>
                <div data-note="C#3" class="black-key" onClick={(e) => handleKey(e)}>
                  S
                </div>
                Z
              </li>
              <li data-note="D3" class="key" onClick={(e) => handleKey(e)}>
                <div data-note="D#3" class="black-key" onClick={(e) => handleKey(e)}>
                  D
                </div>
                X
              </li>
              <li data-note="E3" class="key" onClick={(e) => handleKey(e)}>
                C
              </li>
              <li data-note="F3" class="key"  onClick={(e) => handleKey(e)}>
                <div data-note="F#3" class="black-key"  onClick={(e) => handleKey(e)}>
                  G
                </div>
                V
              </li>
              <li data-note="G3" class="key"  onClick={(e) => handleKey(e)} >
                <div data-note="G#3" class="black-key"  onClick={(e) => handleKey(e)}> 
                  H
                </div>
                B
              </li>
              <li data-note="A3" class="key"  onClick={(e) => handleKey(e)}>
                <div data-note="A#3" class="black-key"  onClick={(e) => handleKey(e)}>
                  J
                </div>
                N
              </li>
              <li data-note="B4" class="key"  onClick={(e) => handleKey(e)}>
                M
              </li>

              <li data-note="C4" class="key" onClick={(e) => handleKey(e)}>
                <div data-note="C#4" class="black-key" onClick={(e) => handleKey(e)}>
                  2
                </div>
                Q
              </li>
              <li data-note="D4" class="key" onClick={(e) => handleKey(e)}>
                <div data-note="D#4" class="black-key" onClick={(e) => handleKey(e)}>
                  3
                </div>
                W
              </li>
              <li data-note="E4" class="key" onClick={(e) => handleKey(e)}>
                E
              </li>
              <li data-note="F4" class="key" onClick={(e) => handleKey(e)}>
                <div data-note="F#4" class="black-key" onClick={(e) => handleKey(e)}>
                  5
                </div>
                R
              </li>
              <li data-note="G4" class="key" onClick={(e) => handleKey(e)}>
                <div data-note="G#4" class="black-key" onClick={(e) => handleKey(e)}>
                  6
                </div>
                T
              </li>
              <li data-note="A4" class="key" onClick={(e) => handleKey(e)}>
                <div data-note="A#4" class="black-key" onClick={(e) => handleKey(e)}>
                  7
                </div>
                Y
              </li>
